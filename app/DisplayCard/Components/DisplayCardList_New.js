 ...
 * Now with URL-based filter persistence!
 */
const DisplayCardList_New = ({ onEdit, showStats = true, onToggleStats }) => {
  ...
  // 1. Read directly from URL - Single Source of Truth
  ...
  // 3. Handlers directly update URL
  const handleCategoryChange = (value) => {
    updateURL({ category: value, subcategory: 'all', page: '1' })
  }
  ...
  // 4. Data fetching uses derived URL values
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Sticky Header Section - Stats, Reading Progress, Filters */}
          ...
          <CardContent className="p-0">
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-muted/50 border-b-2 sticky top-0">
                  <tr>
